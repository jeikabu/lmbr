...
fn main() {
    ...
    let ly_code = PathBuf::from(env::var("LMBR_CODE").unwrap());
    ...
    if cfg!(feature = "lmbr_fw_azcore") {
        builder = builder.header("wrapper_fw_azcore.hpp")
            ...
            .module_raw_lines("root::AZ", ["pub type u16 = crate::U16;", "pub type u32 = crate::U32;", "pub type u64 = crate::U64;"].iter().map(|s| *s))
